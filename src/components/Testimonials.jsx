  ...
  return (
    <motion.div
      ...
      <h1 className='text-2xL sm:text-4xl font-bold mb-2 text-center'>
        Customar <span className='underline underline-offset-4 decoration-1 under font-light'>Testimonials</span>
      </h1>
        ...
        {testimonialsData.map((testimonial, index)=>(
          <div key={index} className='max-w-[340px] shadow-lg rounded px-8 py-12 text-center'>
            ...
            <div className='flex justify-center gap-1 text-red-500 mb-4'>
              {Array.from({length: testimonial.rating}, (ClipboardItem, index)=>(
